...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        "prototype$__findById__donations": {
          ...
          url: urlBase + "/users/:id/donations/:fk",
          method: "GET"
        },
        ...
        "prototype$__get__donations": {
          isArray: true,
          url: urlBase + "/users/:id/donations",
          method: "GET"
        },
        ...
        "prototype$__count__donations": {
          url: urlBase + "/users/:id/donations/count",
          method: "GET"
        },
    ...
    */
     ...
     * manipulating `Donation` instances related to `User`.
     *
